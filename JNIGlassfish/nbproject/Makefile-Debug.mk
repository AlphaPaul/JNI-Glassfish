...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/libJNIGlassfish.so

dist/libJNIGlassfish.so: ${OBJECTFILES}
	${MKDIR} -p dist
	${LINK.c} -o dist/libJNIGlassfish.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
